...
类型检查、114 项前端测试与 release 构建通过。独立 Tauri / WebView2 检查覆盖顶部 / 中部 / 底部拖动、零滚动条占位、滑块拖动 / 滚轮 / 键盘、大小任务划线、记录输入及保存、页面切换、透明态和迷你宠物；见 [拖动与滚动验收](verification/paper-chrome-20260916/README.md)。这部分已合并至 0.6.4；本次集成验证与交付见版本记录。
