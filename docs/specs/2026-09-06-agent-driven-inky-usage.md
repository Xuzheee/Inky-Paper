...
> 2026-09-07 实施范围：本步只连接 Inky 自身任务，完全不涉及 PKC 或任何 Obsidian 仓库。已新增主任务编辑、共享保存和 MCP 任务接口；本文其余看板、日志、预计用时等仍为后续规划。实际使用与范围见 [Agent 协作使用说明](../archive/legacy-docs/Agent协作使用说明.md)。
